...
# instance fields
.field protected volatile a:Ld/n/a/b;
...
.method public c()V
    ...
    iget-object v0, p0, Landroidx/room/j;->c:Ld/n/a/c;

    invoke-interface {v0}, Ld/n/a/c;->getWritableDatabase()Ld/n/a/b;

    move-result-object v0

    iget-object v1, p0, Landroidx/room/j;->d:Landroidx/room/g;

    invoke-virtual {v1, v0}, Landroidx/room/g;->m(Ld/n/a/b;)V

    invoke-interface {v0}, Ld/n/a/b;->beginTransaction()V

    return-void
.end method

.method public d(Ljava/lang/String;)Ld/n/a/f;
    .locals 1
    ...
    invoke-interface {v0, p1}, Ld/n/a/b;->compileStatement(Ljava/lang/String;)Ld/n/a/f;
...
.method protected abstract f(Landroidx/room/a;)Ld/n/a/c;
.end method
...
.method public g()V
    ...
    invoke-interface {v0}, Ld/n/a/b;->endTransaction()V
...
.method public k()Z
    ...
    invoke-interface {v0}, Ld/n/a/b;->inTransaction()Z
...
.method public l(Landroidx/room/a;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/room/j;->f(Landroidx/room/a;)Ld/n/a/c;

    move-result-object v0

    iput-object v0, p0, Landroidx/room/j;->c:Ld/n/a/c;
    ...
    invoke-virtual {v0, p1}, Landroidx/room/n;->n(Landroidx/room/a;)V
    ...
    invoke-interface {v0, v2}, Ld/n/a/c;->setWriteAheadLoggingEnabled(Z)V
...
.method protected m(Ld/n/a/b;)V
    .locals 1

    iget-object v0, p0, Landroidx/room/j;->d:Landroidx/room/g;

    invoke-virtual {v0, p1}, Landroidx/room/g;->d(Ld/n/a/b;)V
...
.method public o()Z
    ...
    iget-object v0, p0, Landroidx/room/j;->a:Ld/n/a/b;

    if-eqz v0, :cond_0

    invoke-interface {v0}, Ld/n/a/b;->isOpen()Z
...
.method public p(Ld/n/a/e;)Landroid/database/Cursor;
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0}, Landroidx/room/j;->q(Ld/n/a/e;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
...
.method public q(Ld/n/a/e;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    .locals 2
    ...
    invoke-interface {v0, p1, p2}, Ld/n/a/b;->query(Ld/n/a/e;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    :cond_0
    iget-object p2, p0, Landroidx/room/j;->c:Ld/n/a/c;

    invoke-interface {p2}, Ld/n/a/c;->getWritableDatabase()Ld/n/a/b;

    move-result-object p2

    invoke-interface {p2, p1}, Ld/n/a/b;->query(Ld/n/a/e;)Landroid/database/Cursor;
...
.method public r()V
    ...
    invoke-interface {v0}, Ld/n/a/b;->setTransactionSuccessful()V
