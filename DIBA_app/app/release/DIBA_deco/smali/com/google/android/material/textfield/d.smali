...
.method private D(Landroid/widget/AutoCompleteTextView;)V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/d;->m:Le/c/a/a/z/g;
...
.method private u(Landroid/widget/AutoCompleteTextView;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/material/textfield/TextInputLayout;->getBoxBackground()Le/c/a/a/z/g;

    move-result-object v1

    sget v2, Le/c/a/a/b;->colorControlHighlight:I

    invoke-static {p1, v2}, Le/c/a/a/q/a;->c(Landroid/view/View;I)I
    ...
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->w(Landroid/widget/AutoCompleteTextView;I[[ILe/c/a/a/z/g;)V
    ...
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->v(Landroid/widget/AutoCompleteTextView;I[[ILe/c/a/a/z/g;)V
...
.method private v(Landroid/widget/AutoCompleteTextView;I[[ILe/c/a/a/z/g;)V
    .locals 5
    ...
    invoke-static {p2, v0, v1}, Le/c/a/a/q/a;->f(IIF)I
    ...
    invoke-static {p1, p3}, Ld/g/l/s;->l0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p4}, Le/c/a/a/z/g;->C()Le/c/a/a/z/k;

    move-result-object v4

    invoke-direct {v0, v4}, Le/c/a/a/z/g;-><init>(Le/c/a/a/z/k;)V

    new-instance v4, Landroid/content/res/ColorStateList;

    invoke-direct {v4, p3, v2}, Landroid/content/res/ColorStateList;-><init>([[I[I)V

    invoke-virtual {v0, v4}, Le/c/a/a/z/g;->V(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1, p2}, Ld/g/l/s;->l0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    invoke-static {p1, p3, p4, v0, v1}, Ld/g/l/s;->u0(Landroid/view/View;IIII)V

    :goto_0
    return-void
.end method

.method private w(Landroid/widget/AutoCompleteTextView;I[[ILe/c/a/a/z/g;)V
    .locals 7

    sget v0, Le/c/a/a/b;->colorSurface:I

    invoke-static {p1, v0}, Le/c/a/a/q/a;->c(Landroid/view/View;I)I
    ...
    invoke-static {p2, v0, v2}, Le/c/a/a/q/a;->f(IIF)I
    ...
    invoke-virtual {v1, v6}, Le/c/a/a/z/g;->V(Landroid/content/res/ColorStateList;)V

    sget-boolean v3, Lcom/google/android/material/textfield/d;->q:Z

    if-eqz v3, :cond_0

    invoke-virtual {v1, v0}, Le/c/a/a/z/g;->setTint(I)V
    ...
    new-instance p3, Le/c/a/a/z/g;

    invoke-virtual {p4}, Le/c/a/a/z/g;->C()Le/c/a/a/z/k;

    move-result-object v0

    invoke-direct {p3, v0}, Le/c/a/a/z/g;-><init>(Le/c/a/a/z/k;)V

    const/4 v0, -0x1

    invoke-virtual {p3, v0}, Le/c/a/a/z/g;->setTint(I)V
...
.method private varargs y(I[F)Landroid/animation/ValueAnimator;
    ...
    sget-object v0, Le/c/a/a/l/a;->a:Landroid/animation/TimeInterpolator;
...
.method private z(FFFI)Le/c/a/a/z/g;
    .locals 1

    invoke-static {}, Le/c/a/a/z/k;->a()Le/c/a/a/z/k$b;

    move-result-object v0

    invoke-virtual {v0, p1}, Le/c/a/a/z/k$b;->z(F)Le/c/a/a/z/k$b;

    invoke-virtual {v0, p1}, Le/c/a/a/z/k$b;->D(F)Le/c/a/a/z/k$b;

    invoke-virtual {v0, p2}, Le/c/a/a/z/k$b;->r(F)Le/c/a/a/z/k$b;

    invoke-virtual {v0, p2}, Le/c/a/a/z/k$b;->v(F)Le/c/a/a/z/k$b;
    ...
    invoke-static {p2, p3}, Le/c/a/a/z/g;->m(Landroid/content/Context;F)Le/c/a/a/z/g;

    move-result-object p2

    invoke-virtual {p2, p1}, Le/c/a/a/z/g;->setShapeAppearanceModel(Le/c/a/a/z/k;)V

    const/4 p1, 0x0

    invoke-virtual {p2, p1, p4, p1, p4}, Le/c/a/a/z/g;->X(IIII)V
...
.method a()V
    ...
    invoke-direct {p0, v0, v0, v1, v2}, Lcom/google/android/material/textfield/d;->z(FFFI)Le/c/a/a/z/g;

    move-result-object v3

    const/4 v4, 0x0

    invoke-direct {p0, v4, v0, v1, v2}, Lcom/google/android/material/textfield/d;->z(FFFI)Le/c/a/a/z/g;

    move-result-object v0

    iput-object v3, p0, Lcom/google/android/material/textfield/d;->m:Le/c/a/a/z/g;
    ...
    :cond_0
    sget v0, Le/c/a/a/e;->mtrl_ic_arrow_drop_down:I
