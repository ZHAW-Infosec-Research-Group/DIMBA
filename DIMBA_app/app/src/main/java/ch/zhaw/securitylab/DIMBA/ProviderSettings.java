...
import ch.zhaw.securitylab.DIMBA.helpers.DatabaseHelper;
...
public class ProviderSettings extends ContentProvider {
	...
	private static final String PROVIDER_NAME = "ch.zhaw.securitylab.DIMBA.settings";
	...
	public boolean onCreate() {
		...
		values.put(FIELD_PACKAGE, "ch.zhaw.securitylab.DIMBA");
		values.put(FIELD_CLASS, "ch.zhaw.securitylab.DIMBA.activity.pay.ActivityAuthPayAccept");
	...
	private static Cursor getCursor() {
		Uri settings = Uri.parse("content://ch.zhaw.securitylab.DIMBA.settings");
		CursorLoader loader = new CursorLoader(DIMBA.get(), settings,null,null,
			null,null);
