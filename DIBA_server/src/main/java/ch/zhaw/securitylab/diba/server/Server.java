...
import ch.zhaw.securitylab.diba.server.controllers.ControllerRegister;
import ch.zhaw.securitylab.diba.server.controllers.ControllerInvestment;
import ch.zhaw.securitylab.diba.server.controllers.ControllerSurvey;
import ch.zhaw.securitylab.diba.server.controllers.ControllerLogin;
import ch.zhaw.securitylab.diba.server.controllers.ControllerMessages;
import ch.zhaw.securitylab.diba.server.controllers.ControllerPayment;
import ch.zhaw.securitylab.diba.server.controllers.ControllerReport;
import ch.zhaw.securitylab.diba.server.controllers.ControllerUser;
...
public class Server {
	...
	public static void main(String[] args) {
		...
		ControllerUser.get().registerUser("h@cker", "diba");
