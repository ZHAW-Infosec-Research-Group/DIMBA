...
import static ch.zhaw.securitylab.diba.server.util.UtilJavalin.getHeaderJwt;
import static ch.zhaw.securitylab.diba.server.util.UtilJavalin.getQueryLoginRedirect;
