...
import ch.zhaw.securitylab.diba.server.util.UtilGson;
import io.javalin.http.Context;
import io.javalin.http.Handler;

import java.util.List;

import static ch.zhaw.securitylab.diba.server.util.Decode.encode;
import static ch.zhaw.securitylab.diba.server.util.Decode.fetch;
...
import ch.zhaw.securitylab.diba.server.responses.MessageResponse;
