package ch.zhaw.securitylab.dimba.server;

import ch.zhaw.securitylab.dimba.server.controllers.ControllerRegister;
import ch.zhaw.securitylab.dimba.server.controllers.ControllerInvestment;
import ch.zhaw.securitylab.dimba.server.controllers.ControllerSurvey;
import ch.zhaw.securitylab.dimba.server.controllers.ControllerLogin;
import ch.zhaw.securitylab.dimba.server.controllers.ControllerMessages;
import ch.zhaw.securitylab.dimba.server.controllers.ControllerPayment;
import ch.zhaw.securitylab.dimba.server.controllers.ControllerReport;
import ch.zhaw.securitylab.dimba.server.controllers.ControllerUser;
...
public class Server {
	...
	public static void main(String[] args) {
		...
		ControllerUser.get().registerUser("h@cker", "dimba");
